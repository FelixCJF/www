...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/web/css/reveal.css?v=1.0">
		<link rel="stylesheet" type="text/css" href="/web/css/self.css?v=1.0">
		<link rel="stylesheet" type="text/css" href="/web//css/style.css?v=1.0">
	...
	<body  onclick="flag=false;$('#poput').css('display','none');">
		<div class="banner" style="text-align: center;">
			<div class="content relative" style="margin:0;text-align: center;">
				...
				<div class="abs" style="height: 37px;background-color: white;position: relative;margin-left: auto;margin-right: auto;">
					...
					<input onclick="if(window.event.stopPropagation)window.event.stopPropagation();else if (window.event)window.event.cancelBubble = true;"  oninput="newsearch(this)" onfocus="flag=false;$('#poput').css('display','');" onblur="setTimeout(function(){if(!flag)$('#poput').css('display','none');}, 500);"  id="bdcsMain" placeholder="搜索" type="text" style="color:black; padding:5px 0px;background-color: white;padding-left: 20px;background-repeat: no-repeat;" value="" autocomplete="off">
				</div>
		...
		<div id="menuTop" style="color: black;width: 100%;text-align: center;">
			<ul style="position: relative;left:-70px;">
				...
				<li style="margin-left: 100px;list-style: none;display: inline-block;cursor: pointer;"><img width="48" height="48" alt="java图标" src="http://www.corer.me/upload/image/20160616/1466045916456772.jpg"><br><div style="text-align: center;width: 48px;">标签</div></li>
...
各种胡言乱语鬼扯蛋...</dd>
	...
	function login(){
		...
		document.getElementById("bdcsMain").onkeypress = function(e){
    		checkChar(e);
		}
